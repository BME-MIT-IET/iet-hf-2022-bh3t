...
A statikus analízis során számos Warningot került felfedezésre a projektben (számszerint összesen 905), azonban ezek nagyrészt ismétlődő hibák vagy stílusbeli problémák voltak, így az egyes hiba típusokat egyszer mutatom csak be, valamint a szükséges javítást sem eszközölöm minden előfordulási helyen.
...
A projekt manuális átvizsgálása során nem találtam nagyobb problémákat, de az alábbi code-smellekre, hibákra lettem figyelmes:
...
- Általánosságban véve sok a nehezen érthető kódrészlet (egymásba ágyazott ternary operator-ok, stb.).